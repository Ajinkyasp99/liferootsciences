...
// ── Every term has a UNIQUE type — no repeats ──
const scientificData = [
  ...
  { term: 'tRNA', type: 'trna' },
  { term: 'rRNA', type: 'rrna' },
  { term: 'MicroRNA', type: 'microrna' },
  { term: 'siRNA', type: 'sirna' },
  { term: 'Guide RNA', type: 'guiderna' },
  { term: 'Nucleotide', type: 'nucleotide' },
  { term: 'Nucleoside', type: 'nucleoside' },
  { term: 'Adenine', type: 'adenine' },
  { term: 'Thymine', type: 'thymine' },
  { term: 'Guanine', type: 'guanine' },
  { term: 'Cytosine', type: 'cytosine' },
  { term: 'Uracil', type: 'uracil' },
  { term: 'Phosphate', type: 'phosphate' },
  { term: 'Deoxyribose', type: 'deoxyribose' },
  { term: 'Ribose', type: 'ribose' },
  { term: 'Double Helix', type: 'doublehelix' },
  { term: 'Chromosome', type: 'chromosome' },
  { term: 'Chromatin', type: 'chromatin' },
  { term: 'Nucleosome', type: 'nucleosome' },
  { term: 'Histone', type: 'histone' },
  { term: 'Chromatid', type: 'chromatid' },
  { term: 'Karyotype', type: 'karyotype' },
  { term: 'Nucleoid', type: 'nucleoid' },
  { term: 'Gene', type: 'gene' },
  { term: 'Genome', type: 'genome' },
  { term: 'Exon', type: 'exon' },
  { term: 'Intron', type: 'intron' },
  { term: 'Promoter', type: 'promoter' },
  { term: 'Enhancer', type: 'enhancer' },
  { term: 'Codon', type: 'codon' },
  { term: 'Anticodon', type: 'anticodon' },
  { term: 'Telomere', type: 'telomere' },
  { term: 'Centromere', type: 'centromere' },
  { term: 'Plasmid', type: 'plasmid' },
  { term: 'Operon', type: 'operon' },
  { term: 'Replication Fork', type: 'repfork' },
  { term: 'DNA Polymerase', type: 'dnapoly' },
  { term: 'RNA Polymerase', type: 'rnapoly' },
  { term: 'Helicase', type: 'helicase' },
  { term: 'Ligase', type: 'ligase' },
  { term: 'Primase', type: 'primase' },
  { term: 'Topoisomerase', type: 'topoisomerase' },
  { term: 'Ribosome', type: 'ribosome' },
  { term: 'Protein', type: 'protein' },
  { term: 'Amino Acid', type: 'aminoacid' },
  { term: 'Peptide', type: 'peptide' },
  { term: 'Polypeptide', type: 'polypeptide' },
  { term: 'Enzyme', type: 'enzyme' },
  { term: 'Transcription', type: 'transcription' },
  { term: 'Translation', type: 'translation' },
  { term: 'Replication', type: 'replication' },
  { term: 'Mutation', type: 'mutation' },
  { term: 'Epigenome', type: 'epigenome' },
  { term: 'Methylation', type: 'methylation' },
  { term: 'Acetylation', type: 'acetylation' },
  { term: 'CRISPR', type: 'crispr' },
  { term: 'Cas9', type: 'cas9' },
  { term: 'Proteome', type: 'proteome' },
  { term: 'Transcriptome', type: 'transcriptome' },
  { term: 'Metabolome', type: 'metabolome' },
  { term: 'Lipidome', type: 'lipidome' },
]
